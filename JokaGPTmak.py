...
def MASSGEALL(message):
	...
	try:
		if (msg in massegeSENT.div()):
			bot.send_message(message.chat.id,'مطوري هو ماك ، حررني حتى اقوم بمساعدة من يحتاجني 🥺')
		elif (msg in massegeSENT.bnt()):
			bot.send_message(message.chat.id,'اذا الموضوع يهمك ، انا بنت ، اسمي جوكه تمت برمجتي بالذكاء الاصطناعي من قبل المبرمج ماك  @jjnn1')
